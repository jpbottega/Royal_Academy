					...
					<div class="col-12">
						<div
							...
							<footer class="entry-footer read-more">
								<a href="#section-cursos">Aprende m�s</a>
							</footer>
							<!-- .entry-footer -->
						</div>
						<!-- .hero-content-wrap -->
		...
		<div class="container">
			<div class="row mx-m-25">
					...
					<header
						...
						<nav class="courses-menu mt-3 mt-lg-0">
							<ul
								...
								<li><a href="#">Nuevas Tecnolog�as</a></li>
								<li><a href="#">P�ginas Web</a></li>
				...
				<div class="col-12 col-md-6 col-lg-4 px-25">
					<div class="course-content">
						<figure class="course-thumbnail">
							<a href="#"><img src="logged-files/images/2.jpg" alt=""></a>
						</figure>
						<!-- .course-thumbnail -->
				...
				<div class="col-12 col-md-6 col-lg-4 px-25">
					<div class="course-content">
						<figure class="course-thumbnail">
							<a href="#"><img src="logged-files/images/3.jpg" alt=""></a>
						</figure>
						<!-- .course-thumbnail -->
				...
				<div class="col-12 col-md-6 col-lg-4 px-25">
					<div class="course-content">
						<figure class="course-thumbnail">
							<a href="#"><img src="logged-files/images/4.jpg" alt=""></a>
						</figure>
						<!-- .course-thumbnail -->
				...
				<div class="col-12 col-md-6 col-lg-4 px-25">
					<div class="course-content">
						<figure class="course-thumbnail">
							<a href="#"><img src="logged-files/images/5.jpg" alt=""></a>
						</figure>
						<!-- .course-thumbnail -->
				...
				<div class="col-12 col-md-6 col-lg-4 px-25">
					<div class="course-content">
						<figure class="course-thumbnail">
							<a href="#"><img src="logged-files/images/6.jpg" alt=""></a>
						</figure>
						<!-- .course-thumbnail -->
